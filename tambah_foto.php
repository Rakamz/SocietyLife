<?php
    ...
    if(isset($_FILES['lokasifile'])) {
        ...
        if (move_uploaded_file($tmp_name, $lokasiFolder . $namaFileBaru)) {
            ...
            $sql = "INSERT INTO foto (judulfoto, deskripsifoto, albumid, userid, tanggal_dibuat, lokasifile) 
                    VALUES ('$judulfoto', '$deskripsifoto', '$albumid', '$userid', '$tanggal_dibuat', '$namaFileBaru')";

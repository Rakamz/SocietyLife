...
<head>
    ...
    <link rel="stylesheet" href="css/isi_foto.css">
            ...
            <ul class="nav-list">
                ...
                <li>
                    <a href="foto.php">
                        ...
                        <span class="links_name">foto</span>
                    </a>
                    <span class="tooltip">foto</span>
                </li>
                <li class="profile">
    ...
    <section class="home-section">
        ...
        <div class="grid align__item">
            ...
            if (isset($_GET['fotoid'])) {
                ...
                // Tampilkan username
                $query_user = "SELECT username FROM user WHERE userid = (SELECT userid FROM foto WHERE fotoid = $fotoid)";
                $result_user = mysqli_query($conn, $query_user);
                $user = mysqli_fetch_assoc($result_user);
            ?>

                <!-- Tampilkan foto dengan fotoid yang sudah ditentukan -->
                ...
                <div class="post">
                    ...
                    <div class="gambar"><a href="gambar/<?= $data['lokasifile'] ?>">
            ...
            <?php
                ...
                // Tampilkan pesan jika fotoid tidak ditemukan dalam parameter URL
                echo "fotoid tidak ditemukan dalam parameter URL.";
            }
            ?>
